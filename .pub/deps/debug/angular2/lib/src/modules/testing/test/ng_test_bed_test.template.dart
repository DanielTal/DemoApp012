...
class ViewHelloPlaceComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.HelloPlaceComponent) && identical(0, requestNodeIndex))) { return _HelloPlaceComponent_0_3; }
...
class ViewUpdateFailsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.UpdateFailsComponent) && identical(0, requestNodeIndex))) { return _UpdateFailsComponent_0_3; }
    return notFoundResult;
  }
}
...
class ViewConstructorFailsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.ConstructorFailsComponent) && identical(0, requestNodeIndex))) { return _ConstructorFailsComponent_0_3; }
    return notFoundResult;
  }
}
...
class ViewOnInitFailsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.OnInitFailsComponent) && identical(0, requestNodeIndex))) { return _OnInitFailsComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
...
class ViewChangesFailsComponent0 extends DebugAppView<import3.ChangesFailsComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.ThrowsWhenValueTrueComponent) && identical(0, requestNodeIndex))) { return _ThrowsWhenValueTrueComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    dbg(0,0,24);
...
class ViewChangesFailsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.ChangesFailsComponent) && identical(0, requestNodeIndex))) { return _ChangesFailsComponent_0_3; }
    return notFoundResult;
  }
}
