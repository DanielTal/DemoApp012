...
class ViewModalComponent0 extends DebugAppView<import5.ModalComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, import2.ModalControllerDirective) && identical(1, requestNodeIndex))) { return _ModalControllerDirective_1_5; }
...
class ViewModalComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import5.ModalComponent) && identical(0, requestNodeIndex))) { return _ModalComponent_0_3; }
    if ((identical(token, import14.DeferredContentAware) && identical(0, requestNodeIndex))) { return _DeferredContentAware_0_4; }
    if ((identical(token, import5.Modal) && identical(0, requestNodeIndex))) { return _Modal_0_5; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
