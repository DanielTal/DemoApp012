...
class ViewScoreboardComponentHost0 extends DebugAppView<dynamic> {
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _ScoreboardComponent_0_3 = new import7.ScoreboardComponent(_query_ScorecardComponent_0_0,null,this.parentInjector.get(import14.DomService),compView_0.ref);
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import7.ScoreboardComponent) && identical(0, requestNodeIndex))) { return _ScoreboardComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
...
const [const <dynamic>[QueryList, const ContentChildren(ScorecardComponent)], const <dynamic>[String, const Attribute('enableUniformWidths')], const <dynamic>[DomService], const <dynamic>[ChangeDetectorRef]],
(QueryList<ScorecardComponent> _scorecards, String enableUniformWidths, DomService _domService, ChangeDetectorRef _changeDetector) => new ScoreboardComponent(_scorecards, enableUniformWidths, _domService, _changeDetector),
