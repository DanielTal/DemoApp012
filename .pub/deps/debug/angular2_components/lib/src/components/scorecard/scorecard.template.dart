...
class ViewScorecardComponent0 extends DebugAppView<import6.ScorecardComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, NgIf) && identical(1, requestNodeIndex))) { return _NgIf_1_5; }
    ...
    if ((identical(token, TemplateRef) && identical(11, requestNodeIndex))) { return _TemplateRef_11_4; }
    if ((identical(token, NgIf) && identical(11, requestNodeIndex))) { return _NgIf_11_5; }
    if ((identical(token, TemplateRef) && identical(13, requestNodeIndex))) { return _TemplateRef_13_4; }
    if ((identical(token, NgIf) && identical(13, requestNodeIndex))) { return _NgIf_13_5; }
...
class ViewScorecardComponent1 extends DebugAppView<import6.ScorecardComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import15.DomService) && identical(0, requestNodeIndex))) { return _DomService_0_3; }
    if ((identical(token, import16.MaterialRippleComponent) && identical(0, requestNodeIndex))) { return _MaterialRippleComponent_0_4; }
    return notFoundResult;
  }
...
class ViewScorecardComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.ScorecardComponent) && identical(0, requestNodeIndex))) { return _ScorecardComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
