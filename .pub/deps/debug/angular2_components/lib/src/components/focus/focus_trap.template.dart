...
class ViewFocusTrapComponent0 extends DebugAppView<import2.FocusTrapComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import2.FocusContentWrapper) && identical(1, requestNodeIndex))) { return _FocusContentWrapper_1_2; }
...
class ViewFocusTrapComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import2.FocusTrapComponent) && identical(0, requestNodeIndex))) { return _FocusTrapComponent_0_3; }
    return notFoundResult;
  }
