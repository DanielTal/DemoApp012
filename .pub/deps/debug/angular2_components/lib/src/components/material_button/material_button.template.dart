...
class ViewMaterialButtonComponent0 extends DebugAppView<import6.MaterialButtonComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import2.DomService) && identical(1, requestNodeIndex))) { return _DomService_1_3; }
    if ((identical(token, import3.MaterialRippleComponent) && identical(1, requestNodeIndex))) { return _MaterialRippleComponent_1_4; }
...
class ViewMaterialButtonComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import20.AcxDarkTheme) && identical(0, requestNodeIndex))) { return _AcxDarkTheme_0_3; }
    if ((identical(token, import6.MaterialButtonComponent) && identical(0, requestNodeIndex))) { return _MaterialButtonComponent_0_4; }
    if ((identical(token, import21.ButtonDirective) && identical(0, requestNodeIndex))) { return _ButtonDirective_0_5; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
