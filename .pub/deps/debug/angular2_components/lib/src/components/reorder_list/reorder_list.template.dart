...
class ViewReorderListComponentHost0 extends DebugAppView<dynamic> {
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _ReorderListComponent_0_3 = new import4.ReorderListComponent(this.parentInjector.get(import15.ManagedZone),_query_ReorderItemDirective_0_0);
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import4.ReorderListComponent) && identical(0, requestNodeIndex))) { return _ReorderListComponent_0_3; }
...
const [const <dynamic>[ManagedZone], const <dynamic>[QueryList, const ContentChildren(ReorderItemDirective)]],
(ManagedZone _managedZone, QueryList<ReorderItemDirective> _items) => new ReorderListComponent(_managedZone, _items),
