...
class ViewMaterialRippleComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import13.DomService) && identical(0, requestNodeIndex))) { return _DomService_0_3; }
    if ((identical(token, import4.MaterialRippleComponent) && identical(0, requestNodeIndex))) { return _MaterialRippleComponent_0_4; }
