...
class ViewMaterialExpansionPanel0 extends DebugAppView<import6.MaterialExpansionPanel> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, TemplateRef) && identical(18, requestNodeIndex))) { return _TemplateRef_18_4; }
    if ((identical(token, NgIf) && identical(18, requestNodeIndex))) { return _NgIf_18_5; }
    if ((identical(token, TemplateRef) && identical(20, requestNodeIndex))) { return _TemplateRef_20_4; }
    if ((identical(token, NgIf) && identical(20, requestNodeIndex))) { return _NgIf_20_5; }
...
class ViewMaterialExpansionPanel1 extends DebugAppView<import6.MaterialExpansionPanel> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, TemplateRef) && identical(7, requestNodeIndex))) { return _TemplateRef_7_4; }
    if ((identical(token, NgIf) && identical(7, requestNodeIndex))) { return _NgIf_7_5; }
    if ((identical(token, TemplateRef) && identical(15, requestNodeIndex))) { return _TemplateRef_15_4; }
    if ((identical(token, NgIf) && identical(15, requestNodeIndex))) { return _NgIf_15_5; }
...
class ViewMaterialExpansionPanelHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.MaterialExpansionPanel) && identical(0, requestNodeIndex))) { return _MaterialExpansionPanel_0_3; }
    if ((identical(token, import22.DeferredContentAware) && identical(0, requestNodeIndex))) { return _DeferredContentAware_0_4; }
    return notFoundResult;
  }
  void detectChangesInternal() {
