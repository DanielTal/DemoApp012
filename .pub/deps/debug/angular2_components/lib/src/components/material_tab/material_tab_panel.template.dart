...
class ViewMaterialTabPanelComponent0 extends DebugAppView<import5.MaterialTabPanelComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import2.FixedMaterialTabStripComponent) && identical(0, requestNodeIndex))) { return _FixedMaterialTabStripComponent_0_3; }
...
class ViewMaterialTabPanelComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import5.MaterialTabPanelComponent) && identical(0, requestNodeIndex))) { return _MaterialTabPanelComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
