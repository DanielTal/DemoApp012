...
class ViewMaterialTabComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.MaterialTabComponent) && identical(0, requestNodeIndex))) { return _MaterialTabComponent_0_3; }
    if ((identical(token, import6.Tab) && identical(0, requestNodeIndex))) { return _Tab_0_4; }
    if ((identical(token, import15.DeferredContentAware) && identical(0, requestNodeIndex))) { return _DeferredContentAware_0_5; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
