...
class ViewFixedMaterialTabStripComponent0 extends DebugAppView<import7.FixedMaterialTabStripComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, import4.NgFor) && identical(2, requestNodeIndex))) { return _NgFor_2_5; }
...
class ViewFixedMaterialTabStripComponent1 extends DebugAppView<import7.FixedMaterialTabStripComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import19.FocusItemDirective) && identical(0, requestNodeIndex))) { return _FocusItemDirective_0_3; }
    if ((identical(token, import20.TabButtonComponent) && identical(0, requestNodeIndex))) { return _TabButtonComponent_0_4; }
    if ((identical(token, import21.FocusableItem) && identical(0, requestNodeIndex))) { return _FocusableItem_0_5; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    dbg(0,16,14);
...
class ViewFixedMaterialTabStripComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import7.FixedMaterialTabStripComponent) && identical(0, requestNodeIndex))) { return _FixedMaterialTabStripComponent_0_3; }
    return notFoundResult;
  }
}
