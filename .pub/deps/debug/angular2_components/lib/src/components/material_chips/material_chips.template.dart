...
class ViewMaterialChipsComponent0 extends DebugAppView<import6.MaterialChipsComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, import3.NgFor) && identical(1, requestNodeIndex))) { return _NgFor_1_5; }
...
class ViewMaterialChipsComponent1 extends DebugAppView<import6.MaterialChipsComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import16.MaterialChipComponent) && identical(0, requestNodeIndex))) { return _MaterialChipComponent_0_3; }
    if ((identical(token, import17.HasRenderer) && identical(0, requestNodeIndex))) { return _HasRenderer_0_4; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    bool changed = true;
...
class ViewMaterialChipsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.MaterialChipsComponent) && identical(0, requestNodeIndex))) { return _MaterialChipsComponent_0_3; }
    if ((identical(token, import17.HasRenderer) && identical(0, requestNodeIndex))) { return _HasRenderer_0_4; }
    return notFoundResult;
  }
