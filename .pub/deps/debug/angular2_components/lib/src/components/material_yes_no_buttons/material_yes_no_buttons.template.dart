...
class ViewMaterialYesNoButtonsComponent0 extends DebugAppView<import6.MaterialYesNoButtonsComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, TemplateRef) && identical(5, requestNodeIndex))) { return _TemplateRef_5_4; }
    if ((identical(token, NgIf) && identical(5, requestNodeIndex))) { return _NgIf_5_5; }
...
class ViewMaterialYesNoButtonsComponent1 extends DebugAppView<import6.MaterialYesNoButtonsComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import16.MaterialSpinnerComponent) && identical(2, requestNodeIndex))) { return _MaterialSpinnerComponent_2_3; }
    return notFoundResult;
  }
}
...
class ViewMaterialYesNoButtonsComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import6.MaterialYesNoButtonsComponent) && identical(0, requestNodeIndex))) { return _MaterialYesNoButtonsComponent_0_3; }
    return notFoundResult;
  }
}
