...
class ViewMaterialDialogComponent0 extends DebugAppView<import7.MaterialDialogComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    ...
    if ((identical(token, TemplateRef) && identical(6, requestNodeIndex))) { return _TemplateRef_6_4; }
    if ((identical(token, NgIf) && identical(6, requestNodeIndex))) { return _NgIf_6_5; }
...
class ViewMaterialDialogComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import7.MaterialDialogComponent) && identical(0, requestNodeIndex))) { return _MaterialDialogComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
