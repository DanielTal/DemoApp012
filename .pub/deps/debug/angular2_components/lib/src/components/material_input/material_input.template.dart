...
class ViewMaterialInputComponent0 extends DebugAppView<import11.MaterialInputComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, TemplateRef) && identical(2, requestNodeIndex))) { return _TemplateRef_2_4; }
    if ((identical(token, NgIf) && identical(2, requestNodeIndex))) { return _NgIf_2_5; }
    if ((identical(token, TemplateRef) && identical(3, requestNodeIndex))) { return _TemplateRef_3_4; }
    if ((identical(token, NgIf) && identical(3, requestNodeIndex))) { return _NgIf_3_5; }
    if ((identical(token, import4.DefaultValueAccessor) && identical(8, requestNodeIndex))) { return _DefaultValueAccessor_8_2; }
    if ((identical(token, import5.FocusableDirective) && identical(8, requestNodeIndex))) { return _FocusableDirective_8_3; }
    if ((identical(token, import6.NG_VALUE_ACCESSOR) && identical(8, requestNodeIndex))) { return _NG_VALUE_ACCESSOR_8_4; }
    if ((identical(token, import7.NgModel) && identical(8, requestNodeIndex))) { return _NgModel_8_5; }
    if ((identical(token, import8.NgControl) && identical(8, requestNodeIndex))) { return _NgControl_8_6; }
    if ((identical(token, TemplateRef) && identical(9, requestNodeIndex))) { return _TemplateRef_9_4; }
    if ((identical(token, NgIf) && identical(9, requestNodeIndex))) { return _NgIf_9_5; }
    if ((identical(token, TemplateRef) && identical(10, requestNodeIndex))) { return _TemplateRef_10_4; }
    if ((identical(token, NgIf) && identical(10, requestNodeIndex))) { return _NgIf_10_5; }
    if ((identical(token, TemplateRef) && identical(15, requestNodeIndex))) { return _TemplateRef_15_4; }
    if ((identical(token, NgIf) && identical(15, requestNodeIndex))) { return _NgIf_15_5; }
...
class ViewMaterialInputComponent1 extends DebugAppView<import11.MaterialInputComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import22.GlyphComponent) && identical(1, requestNodeIndex))) { return _GlyphComponent_1_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    bool changed = true;
...
class ViewMaterialInputComponent5 extends DebugAppView<import11.MaterialInputComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, TemplateRef) && identical(1, requestNodeIndex))) { return _TemplateRef_1_4; }
    if ((identical(token, import24.NgSwitchWhen) && identical(1, requestNodeIndex))) { return _NgSwitchWhen_1_5; }
    if ((identical(token, TemplateRef) && identical(2, requestNodeIndex))) { return _TemplateRef_2_4; }
    if ((identical(token, import24.NgSwitchWhen) && identical(2, requestNodeIndex))) { return _NgSwitchWhen_2_5; }
    if ((identical(token, TemplateRef) && identical(3, requestNodeIndex))) { return _TemplateRef_3_4; }
    if ((identical(token, import24.NgSwitchWhen) && identical(3, requestNodeIndex))) { return _NgSwitchWhen_3_5; }
    if ((identical(token, TemplateRef) && identical(4, requestNodeIndex))) { return _TemplateRef_4_4; }
    if ((identical(token, NgIf) && identical(4, requestNodeIndex))) { return _NgIf_4_5; }
...
class ViewMaterialInputComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import25.DeferredValidator) && identical(0, requestNodeIndex))) { return _DeferredValidator_0_3; }
    if ((identical(token, import11.MaterialInputComponent) && identical(0, requestNodeIndex))) { return _MaterialInputComponent_0_4; }
    if ((identical(token, import26.NG_VALIDATORS) && identical(0, requestNodeIndex))) { return _NG_VALIDATORS_0_5; }
    if ((identical(token, import27.ReferenceDirective) && identical(0, requestNodeIndex))) { return _ReferenceDirective_0_6; }
    if ((identical(token, import5.Focusable) && identical(0, requestNodeIndex))) { return _Focusable_0_7; }
    if ((identical(token, import28.BaseMaterialInput) && identical(0, requestNodeIndex))) { return _BaseMaterialInput_0_8; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
