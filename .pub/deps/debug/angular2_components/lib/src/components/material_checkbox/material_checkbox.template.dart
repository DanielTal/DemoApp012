...
class ViewMaterialCheckboxComponent0 extends DebugAppView<import7.MaterialCheckboxComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import2.GlyphComponent) && identical(1, requestNodeIndex))) { return _GlyphComponent_1_3; }
...
class ViewMaterialCheckboxComponent1 extends DebugAppView<import7.MaterialCheckboxComponent> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import17.DomService) && identical(0, requestNodeIndex))) { return _DomService_0_3; }
    if ((identical(token, import18.MaterialRippleComponent) && identical(0, requestNodeIndex))) { return _MaterialRippleComponent_0_4; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    bool changed = true;
...
class ViewMaterialCheckboxComponentHost0 extends DebugAppView<dynamic> {
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import7.MaterialCheckboxComponent) && identical(0, requestNodeIndex))) { return _MaterialCheckboxComponent_0_3; }
    return notFoundResult;
  }
  void detectChangesInternal() {
    this.detectContentChildrenChanges();
