...
class ViewMaterialRadioGroupComponentHost0 extends DebugAppView<dynamic> {
  ...
  ViewContainer createInternal(dynamic rootSelector) {
    ...
    _MaterialRadioGroupComponent_0_3 = new import4.MaterialRadioGroupComponent(this.parentInjector.get(import14.ManagedZone),_query_MaterialRadioComponent_0_0,null);
  ...
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import4.MaterialRadioGroupComponent) && identical(0, requestNodeIndex))) { return _MaterialRadioGroupComponent_0_3; }
...
const [const <dynamic>[ManagedZone], const <dynamic>[QueryList, const ContentChildren(MaterialRadioComponent)], const <dynamic>[NgControl, const Self(), const Optional()]],
(ManagedZone _managedZone, QueryList components, NgControl cd) => new MaterialRadioGroupComponent(_managedZone, components, cd),
